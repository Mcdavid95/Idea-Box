...
import ConnectedCategoryPage, { CategoryPage } from '../../containers/CategoryPage';
...
describe('Comment form component test', () => {
  it('should call the method componentDidMount', () => {
    const component = shallow(<CategoryPage {...props} />);
  ...
  it('has map state to props', () => {
    const component = shallow(<ConnectedCategoryPage {...props} store={store} />);
